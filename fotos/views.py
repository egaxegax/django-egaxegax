...
def index(request):
    return render_to_response('index.html', 
                              ...
                              {'request': request,
                               'logback': reverse('fotos.views.index')}))
...
def list_photos(request, **kw):
    ...
    return render_to_response('photos.html', 
                              ...
                              {'request': request,
                               ...
                               'album': album,
                               'logback': reverse('fotos.views.list_photos')}))
...
#                     img = images.Image(image_data=data)
                ...
                return HttpResponseRedirect(reverse('fotos.views.list_photos', kwargs={'id_album': photo.id}))
            except:
                pass
    else:
        form = AddPhotoForm()
    view_url = reverse('fotos.views.add_photo')
    upload_url, upload_data = prepare_upload(request, view_url)
...
def edit_photo(request, **kw):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            ClearPhotosListCache(photo.album)
            ClearPhotosFullListCache()
            return HttpResponseRedirect(reverse('fotos.views.list_photos', kwargs={'id_album': id_photo}))
    else:
...
#            ClearPhotosFullListCache()
            photo.delete()
    return HttpResponseRedirect(reverse('fotos.views.list_photos'))
